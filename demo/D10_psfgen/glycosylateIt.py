...
myGlycosylator.load_glycoprotein('4tvp_autopsf.pdb')
...
myGlycosylator.write_glycoprotein('4tvp_step_0.pdb')
...
################################################################################
# 6. Write files for psfgen
# All glycans and psfgen configuration script will be saved in topo_final
# To create full topology run: vmd -dispdev text -e psfgen.conf
# This requires to have first built the full topology of the protein (4tv_autopsf
myGlycosylator.write_psfgen("topo_final", "../4tvp_autopsf")
