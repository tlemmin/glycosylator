...
r,a = myBuilder.add_missing_atoms(myMol.molecule['G'][1])
...
r2, da = myBuilder.build_from_patch(r, 2, 'NAG', r.getChids()[0], r.getSegnames()[0], '14bb')
writePDB('NAG2_complete.pdb', r2)
#Build a MAN ab initio
rd = myBuilder.build_from_DUMMY(1, 'MAN', 'G', '1G', 'DUMMY_MAN')
...
man6  = myGlycosylator.glycosylate('MAN6_1;3,2', template_glycan_tree = connect_tree, template_glycan = myMan9.molecule)
